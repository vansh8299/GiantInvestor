...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      text: 'Welcome to Stock Market Assistant! I can help you with:\n' +
            ...
            '- Investment advice\n' +
            '- Financial analysis\n\n' +
            '⚠️ Note: Chat history is automatically deleted after 24 hours',
      sender: 'bot'
    }
  ]);
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      {isOpen && (
        <div className="bg-white border border-gray-200 rounded-lg shadow-2xl w-96 h-[500px] mt-2 mb-11 flex flex-col">
          ...
          <div className="bg-green-500 text-white text-xs p-2 text-center">
            ⚠️ Note: Chat history is automatically deleted after 24 hours
          </div>
          ...
          <div className="border-t border-gray-200 p-4">
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder="Ask about stocks or market trends..."
