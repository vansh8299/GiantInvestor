...
const publicPages = ['/', '/pages/login', '/pages/signup', '/pages/verifyotp', '/pages/resetPassword','/actions/topgainersorlosers','/actions/signupapi','/actions/verifyotp','/actions/loginapi','/actions/forgetpassword', '/pages/forgetpassword']
